...
class School(models.Model):
    ...
    school_name = models.CharField(verbose_name='校区名称', max_length=32)
...
class ClassList(models.Model):
    ...
    teachers = models.ManyToManyField(verbose_name='任课老师', to='User', related_name='teach_classes', limit_choices_to={'department_id': 1003})
    head_teacher = models.ForeignKey(verbose_name='班主任', to='User', related_name='classes', on_delete=models.CASCADE, limit_choices_to={'department_id': 1002})

    def __str__(self):
        return "{0}({1}期)".format(self.course.course_name, self.semester)
...
class Customer(models.Model):
    ...
    profession = models.CharField(verbose_name='所学专业', max_length=64, blank=True, null=True)
    ...
    recv_date = models.DateField(verbose_name='接单日期', null=True, blank=True)
    ...
    consultant = models.ForeignKey(verbose_name="课程顾问", to='User', related_name='consultant',
                                   limit_choices_to={'department_id': 1000}, on_delete=models.CASCADE)
...
class ConsultRecord(models.Model):
    ...
    consultant = models.ForeignKey(verbose_name="跟踪人", to='User', on_delete=models.CASCADE)
...
class PaymentRecord(models.Model):
    ...
    consultant = models.ForeignKey(verbose_name="负责老师", to='User', help_text="谁签的单就选谁", on_delete=models.CASCADE)
...
class CourseRecord(models.Model):
    ...
    teacher = models.ForeignKey(verbose_name="讲师", to='User', on_delete=models.CASCADE)
...
class CustomerDistribution(models.Model):
    ...
    user = models.ForeignKey(verbose_name='客户顾问', to='User', to_field='id', related_name='customer_distribution', limit_choices_to={"department__numbering": 1000}, on_delete=models.CASCADE)
    customer = models.ForeignKey(verbose_name='客户', to='Customer', to_field='id', related_name='dealers', on_delete=models.CASCADE)
    ctime = models.DateField(verbose_name='接单时间')
    status_choices = [
        (1, '正在跟进'),
        (2, '已成单'),
        (3, '3天未跟进'),
